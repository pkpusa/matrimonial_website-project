...
<html lang="zxx">
<head>
<title>| Login :: Life Partner</title>
<!-- for-mobile-apps -->
...
<div class="login elite-app">
	...
	<div class="col-md-8 login-form-w3-agile">
		...
		<div class="col-md-4 login-right-info">
			<h3 class="subhead-agileits">Why Join Life Partner Matrimonial</h3>
			<p class="para-agileits-w3layouts" >LIfe Partner Matrimonail Gives You following Features</p>
			<ul>
		...
		<div class="container">
				<div class="w3ls_footer_grid">
					<div class="col-md-4 w3ls_footer_grid_left">
							<h4>Location:</h4>
							<p>Life Partner Matrimonail, S G Palaya,<br> Banglore, INDIA</p>
					</div>
					<div class="col-md-4 w3ls_footer_grid_left">
							<h4>Contact us:</h4>
...
<div class="footer-w3layouts">
				...
				<div class="agile-copy">
					<p>© 2017 Life Partner Matrimonial. All rights reserved | Design by <a href="http://w3layouts.com/">Prakash Thakur</a></p>
				</div>
